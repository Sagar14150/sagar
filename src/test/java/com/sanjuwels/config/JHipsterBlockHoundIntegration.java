...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.sanjuwels.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.sanjuwels.security.DomainUserDetailsService", "createSpringSecurityUser");
